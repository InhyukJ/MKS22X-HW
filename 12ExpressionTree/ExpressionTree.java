...
public class ExpressionTree{ 
	...
	else return calc(getOp(), getLeft().calc(), getRight().calc());
    }
    
    private double calc(char op, double do1, double do2) {
	if (op.equals('+')) return do1 + do2;
	else if (op.equal('-')) return do1 - do2;
